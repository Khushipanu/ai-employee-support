...
function HRContent() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-semibold tracking-tight text-neutral-900">HR Dashboard</h1>
      <p className="mt-1 text-sm text-neutral-500">
        All HR tickets raised by employees across the company.
      </p>
...
export default function HRPage() {
  return <ProtectedRoute allowedRoles={["HR"]}>{() => <HRContent />}</ProtectedRoute>;
}
